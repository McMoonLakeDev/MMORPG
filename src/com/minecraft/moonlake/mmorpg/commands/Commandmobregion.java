 ...
 */
public class Commandmobregion extends MMORPGCommands {

    public Commandmobregion() {
     ...
     */
    @Override
    @Command(usage = "/mobregion help", min = 1, max = 4, help = "command.mobRegion.help", pre = "moonlake.mmorpg.mobRegion")
    public void run(MMORPGPlayer mmorpgPlayer, CommandContent content) {
        ...
        if(content.argsLength() == 1) {
            ...
            if(content.equalsIgnoreCase(0, "help")) {
                ...
                mogRegionHelp(mmorpgPlayer);
            }
        }
    }

    private void mogRegionHelp(MMORPGPlayer mmorpgPlayer) {
