 ...
 */
public class RenameCardPlayer extends AbstractRenameCard {

    public RenameCardPlayer() {

        this(1);
    }

    public RenameCardPlayer(int amount) {

        super(RenameCardType.PLAYER_RENAME_CARD, amount);
    }
