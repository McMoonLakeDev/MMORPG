...
package com.minecraft.moonlake.mmorpg.api.player;
...
/**
 * 月色之湖大型角色扮演服务器 玩家 接口类
 * Created by MoonLake on 2016/5/16.
 */
public interface MMORPGPlayer extends MoonLakePlayer {
     ...
     * @param amount 数量
     */
    void giveRPGHealth(double amount);
     ...
     * @param amount 数量
     */
    void takeRPGHealth(double amount);
     ...
     * @param health 血量
     */
    void setRPGHealth(double health);
     ...
     */
    void setRPGMaxHealth(double maxHealth);
     ...
     * @param items 物品栈
     */
    void addItemStack(EnumAddItemStackCallBack callBack, ItemStack... items);
