...
import com.minecraft.moonlake.mmorpg.api.skill.active.Cleave;
import com.minecraft.moonlake.mmorpg.api.skill.active.Frantic;
import com.minecraft.moonlake.mmorpg.api.skill.active.Shake;
import com.minecraft.moonlake.mmorpg.api.skill.active.Tearing;
import com.minecraft.moonlake.mmorpg.api.skill.passive.Passive;
import com.minecraft.moonlake.mmorpg.api.skill.passive.type.Fighting;
...
import com.minecraft.moonlake.mmorpg.api.skill.ultimate.type.PolesFlip;
...
public class Warrior extends AbstractRole {
    ...
    private final static RoleType type = RoleType.WARRIOR;
    ...
    public Warrior() {
        ...
        weaponType = Material.IRON_SPADE;

        // skill, talent, passive, ultimate
        skills = new Skill[] { new Cleave(), new Frantic(), new Shake(), new Tearing() };
        talents = new Talent[] { };
        passive = new Fighting();
        ultimate = new PolesFlip();
    }
