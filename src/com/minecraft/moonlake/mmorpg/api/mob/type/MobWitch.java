 ...
 */
public class MobWitch extends AbstractMob {

    public MobWitch(org.bukkit.entity.Entity entity) {

        super(MobType.WITCH, entity);
    }

    @Override
    public Witch asLiving() {

        return (Witch) super.asLiving();
    }
}
