 ...
 */
public class MobSnowman extends AbstractMob {

    public MobSnowman(org.bukkit.entity.Entity entity) {

        super(MobType.SNOWMAN, entity);
    }

    @Override
    public Snowman asLiving() {

        return (Snowman) super.asLiving();
    }
}
