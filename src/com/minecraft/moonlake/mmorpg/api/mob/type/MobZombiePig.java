...
public class MobZombiePig extends MobZombie {
    ...
    public MobZombiePig(org.bukkit.entity.Entity entity) {

        super(MobType.ZOMBIE_PIG, entity);
    }

    protected MobZombiePig(MobType mobType, org.bukkit.entity.Entity entity) {

        super(mobType, entity);
    }

    @Override
    public PigZombie asLiving() {

        return (PigZombie) super.asLiving();
    }
