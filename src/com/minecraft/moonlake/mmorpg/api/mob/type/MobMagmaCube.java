 ...
 */
public class MobMagmaCube extends AbstractMob {

    public MobMagmaCube(org.bukkit.entity.Entity entity) {

        super(MobType.MAGMA_CUBE, entity);
    }

    @Override
    public MagmaCube asLiving() {

        return (MagmaCube) super.asLiving();
    }
}
