 ...
 */
public class MobEndermite extends AbstractMob {

    public MobEndermite(org.bukkit.entity.Entity entity) {

        super(MobType.ENDER_MITE, entity);
    }

    @Override
    public Endermite asLiving() {

        return (Endermite) super.asLiving();
    }
}
