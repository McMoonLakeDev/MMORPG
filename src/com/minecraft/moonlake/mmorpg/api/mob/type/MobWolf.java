 ...
 */
public class MobWolf extends AbstractMob {

    public MobWolf(org.bukkit.entity.Entity entity) {

        super(MobType.WOLF, entity);
    }

    @Override
    public Wolf asLiving() {

        return (Wolf) super.asLiving();
    }
}
