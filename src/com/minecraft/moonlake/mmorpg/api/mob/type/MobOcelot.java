 ...
 */
public class MobOcelot extends AbstractMob {

    public MobOcelot(org.bukkit.entity.Entity entity) {

        super(MobType.OCELOT, entity);
    }

    @Override
    public Ocelot asLiving() {

        return (Ocelot) super.asLiving();
    }
}
