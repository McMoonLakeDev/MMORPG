 ...
 */
public class MobSlime extends AbstractMob {

    public MobSlime(org.bukkit.entity.Entity entity) {

        super(MobType.SLIME, entity);
    }

    @Override
    public Slime asLiving() {

        return (Slime) super.asLiving();
    }
}
