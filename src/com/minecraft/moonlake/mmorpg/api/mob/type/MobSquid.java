 ...
 */
public class MobSquid extends AbstractMob {

    public MobSquid(org.bukkit.entity.Entity entity) {

        super(MobType.SQUID, entity);
    }

    @Override
    public Squid asLiving() {

        return (Squid) super.asLiving();
    }
}
