 ...
 */
public class MobSheep extends AbstractMob {

    public MobSheep(org.bukkit.entity.Entity entity) {

        super(MobType.SHEEP, entity);
    }

    @Override
    public Sheep asLiving() {

        return (Sheep) super.asLiving();
    }
}
