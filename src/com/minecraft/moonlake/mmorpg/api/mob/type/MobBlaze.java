 ...
 */
public class MobBlaze extends AbstractMob {

    public MobBlaze(org.bukkit.entity.Entity entity) {

        super(MobType.BLAZE, entity);
    }

    @Override
    public Blaze asLiving() {

        return (Blaze) super.asLiving();
    }
}
