 ...
 */
public class MobHorse extends AbstractMob {

    public MobHorse(org.bukkit.entity.Entity entity) {

        super(MobType.HORSE, entity);
    }

    @Override
    public Horse asLiving() {

        return (Horse) super.asLiving();
    }
}
