 ...
 */
public class MobEnderman extends AbstractMob {

    public MobEnderman(org.bukkit.entity.Entity entity) {

        super(MobType.ENDERMAN, entity);
    }

    @Override
    public Enderman asLiving() {

        return (Enderman) super.asLiving();
    }
}
