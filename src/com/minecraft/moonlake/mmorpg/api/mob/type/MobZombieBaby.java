 ...
 */
public class MobZombieBaby extends MobZombie implements MobKnight {

    private MobChicken knight;

    public MobZombieBaby(org.bukkit.entity.Entity entity) {

       this(MobType.ZOMBIE_BABY, entity);
    }

    protected MobZombieBaby(MobType mobType, org.bukkit.entity.Entity entity) {
