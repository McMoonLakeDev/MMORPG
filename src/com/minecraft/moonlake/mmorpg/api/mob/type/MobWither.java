 ...
 */
public class MobWither extends AbstractMob {

    public MobWither(org.bukkit.entity.Entity entity) {

        super(MobType.WITHER, entity);
    }

    @Override
    public Wither asLiving() {

        return (Wither) super.asLiving();
    }
}
