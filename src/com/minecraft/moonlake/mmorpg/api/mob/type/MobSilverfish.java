 ...
 */
public class MobSilverfish extends AbstractMob {

    public MobSilverfish(org.bukkit.entity.Entity entity) {

        super(MobType.SILVERFISH, entity);
    }

    @Override
    public Silverfish asLiving() {

        return (Silverfish) super.asLiving();
    }
}
