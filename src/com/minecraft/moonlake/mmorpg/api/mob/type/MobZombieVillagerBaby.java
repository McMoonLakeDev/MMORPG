 ...
 */
public class MobZombieVillagerBaby extends MobZombieVillager {

    private MobChicken knight;

    public MobZombieVillagerBaby(org.bukkit.entity.Entity entity) {

        super(MobType.ZOMBIE_VILLAGER_BABY, entity);
