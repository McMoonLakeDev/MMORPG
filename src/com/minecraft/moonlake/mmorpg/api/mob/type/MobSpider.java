 ...
 */
public class MobSpider extends AbstractMob {

    public MobSpider(org.bukkit.entity.Entity entity) {

        this(MobType.SPIDER, entity);
    }

    protected MobSpider(MobType mobType, org.bukkit.entity.Entity entity) {

        super(mobType, entity);
    }

    @Override
    public Spider asLiving() {

        return (Spider) super.asLiving();
    }
