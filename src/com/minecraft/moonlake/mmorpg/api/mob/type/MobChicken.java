 ...
 */
public class MobChicken extends AbstractMob {

    public MobChicken(org.bukkit.entity.Entity entity) {

        super(MobType.CHICKEN, entity);
    }

    @Override
    public Chicken asLiving() {

        return (Chicken) super.asLiving();
    }
}
