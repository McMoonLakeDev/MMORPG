 ...
 */
public class MobGhast extends AbstractMob {

    public MobGhast(org.bukkit.entity.Entity entity) {

        super(MobType.GHAST, entity);
    }

    @Override
    public Ghast asLiving() {

        return (Ghast) super.asLiving();
    }
}
