 ...
 */
public class MobPolarBear extends AbstractMob {

    public MobPolarBear(org.bukkit.entity.Entity entity) {

        super(MobType.POLAR_BEAR, entity);
    }

    @Override
    public PolarBear asLiving() {

        return (PolarBear) super.asLiving();
    }
}
