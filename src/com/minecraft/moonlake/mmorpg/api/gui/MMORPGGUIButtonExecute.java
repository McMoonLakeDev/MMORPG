 ...
 */
public interface MMORPGGUIButtonExecute extends GUIButtonExecute {
     ...
     */
    default void execute(GUI gui, Player clicked, GUIButton currentButton) {

        MMORPGPlayer mmorpgPlayer = AccountManager.getPlayer(clicked);

        if(mmorpgPlayer != null) {

            execute(gui, mmorpgPlayer, currentButton);
        }
    }
     ...
     * @param currentButton 点击的按钮对象
     */
    void execute(GUI gui, MMORPGPlayer clicked, GUIButton currentButton);
}
