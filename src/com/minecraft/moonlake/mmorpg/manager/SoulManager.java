 ...
 */
public final class SoulManager extends MMORPGManager {
     ...
     * @return 灵魂数量
     */
    public static int getPlayerSoul(MMORPGPlayer player) {
     ...
     * @return 最大灵魂数量
     */
    public static int getPlayerMaxSoul(MMORPGPlayer player) {
     ...
     * @param player 玩家
     */
    public static void updatePlayerHotBarSoul(MMORPGPlayer player) {
     ...
     * @param amount 数量
     */
    public static void updatePlayerHotBarSoul(String name, int amount) {
